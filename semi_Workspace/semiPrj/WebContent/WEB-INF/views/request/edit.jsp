...
<% RequestVo rv = (RequestVo)request.getAttribute("vo"); %>
	...
	<div id="title">문의게시판 수정</div>
		...
		<div id="main">
			...
			<div class="data1">
				...
				<input type="text" id="t2" name="title" value=<%=rv.getTitle() %>>
			</div>
			
			<div class="data2">
				<input type="text" id="table-content" name="content" value=<%=rv.getContent()%>>
			</div>
		...
		<div id="button-box">
			...
			<div >
				<input type="submit" value="수정하기" class="page-button" id="rollback">
			</div>
			<div><a href="/dobby/request"><div class="page-button" id="rollback">돌아가기</div></a>
