...
#fifth_table_subtext2{
font-size:20px;
color:white;
padding:10px;
margin-left:80px;
}
#fifth_table_subtext3{
font-size:20px;
color:white;
padding:10px;
margin-left:80px;
...
#fifth_table_box-table-result{
	width:50%;
	float:right;
}

#fifth_table_box-table-result>#fifth_table_subtext{
font-size:40px;
color:black;
padding:10px;
margin-left:40%;
}
#fifth_table_box-table-result>#fifth_table_subtext2{
font-size:20px;
color:black;
padding:10px;
margin-left:40%;
}
#fifth_table_box-table-result>#fifth_table_subtext3{
font-size:20px;
color:black;
padding:10px;
margin-left:40%;
...
#fifth_table_box2>#fifth_table_box-table-text>#fifth_table_subtext2{
	margin-top:60px;
	margin-left:20px;
}

#fifth_table_box2>#fifth_table_box-table-text>#fifth_table_subtext3{
	margin-left:20px;
	
}

#fifth_table_box2>#fifth_table_box-table-result>#fifth_table_subtext{
	margin-top:60px;
...
#fifth_table_box3>#fifth_table_box-table-text>#fifth_table_subtext2{
	margin-top:60px;
	margin-left:20px;
}

#fifth_table_box3>#fifth_table_box-table-text>#fifth_table_subtext3{
	margin-left:20px;
}

#fifth_table_box3>#fifth_table_box-table-result>#fifth_table_subtext{
	margin-top:60px;
}


#fifth_table_box4>#fifth_table_box-table-text>#fifth_table_subtext2{
	margin-top:60px;
	margin-left:20px;
}

#fifth_table_box4>#fifth_table_box-table-text>#fifth_table_subtext3{
	margin-left:20px;
}

#fifth_table_box4>#fifth_table_box-table-result>#fifth_table_subtext{
	margin-top:60px;
}
...
<div id="mypage">
    ...
    <div class="info-area" id="info-area05"><!-- 5 보유 포인트-->
        
        
		<form>
			<div id="fifth_table_point-box">
				<div id="fifth_table_text01">포인트</div>
				<div id="fifth_table_box-table-page">
					<div id="fifth_table_box1" class="fifth_table_box">
						<div class="fifth_table_box" id="fifth_table_box-table-text">
							<div id="fifth_table_subtext">현재 포인트</div>
							<div id="fifth_table_subtext2">적립 포인트</div>
							<div id="fifth_table_subtext3">구매 포인트</div>
						</div>
						
						<div class="fifth_table_box" id="fifth_table_box-table-result">
							<div id="fifth_table_subtext">0P</div>
							<div id="fifth_table_subtext2">0P</div>
							<div id="fifth_table_subtext3">0P</div>
						</div>
					</div>
					
					<div id="fifth_table_text02">포인트 적립 내역</div>
					
					<div class="fifth_table_box" id="fifth_table_box2">
							<div class="fifth_table_box" id="fifth_table_box-table-text">
								<div id="fifth_table_subtext2">2022/01/28</div>
								<div id="fifth_table_subtext3">유니글로_포인트</div>
							</div>
							
							<div class="fifth_table_box" id="fifth_table_box-table-result">
								<div id="fifth_table_subtext">120P</div>
							</div>
						
					</div>
					
					<div class="fifth_table_box" id="fifth_table_box3">
							<div class="fifth_table_box" id="fifth_table_box-table-text">
								<div id="fifth_table_subtext2">2022/01/28</div>
								<div id="fifth_table_subtext3">유니글로_포인트</div>
							</div>
					...
					<div class="fifth_table_box" id="fifth_table_box4">
							<div class="fifth_table_box" id="fifth_table_box-table-text">
								<div id="fifth_table_subtext2">2022/01/28</div>
								<div id="fifth_table_subtext3">유니글로_포인트</div>
							</div>
					...
					<div id="fifth_table_text02">포인트 사용 내역</div>
