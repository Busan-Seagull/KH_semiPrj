...
public class ReportDao {
    ...
    public List<ReportVo> selectList(Connection conn, PageVo pv) {
        ...
        String sql = "SELECT * FROM ( SELECT ROWNUM AS RNUM,T.* FROM ( SELECT R.POST_NO ,U.USER_NO ,SERVICE_NO ,R.TITLE , R.CONTENT ,R.WRITE_TIME ,R.DELETE_YN, R.MODIFY_DATE ,R.HANDLE_REPORT_YN ,R.REPORT_COMMENT ,U.NICK AS WRITER FROM REPORT R JOIN \"USER\" U ON R.WRITER = U.USER_NO WHERE R.DELETE_YN = 'N' ORDER BY R.POST_NO DESC )T ) WHERE RNUM BETWEEN ? AND ? ";
    ...
    public ReportVo selectOne(Connection conn, String postNo) {
        String sql = "SELECT R.POST_NO ,U.USER_NO ,SERVICE_NO ,R.TITLE, R.CONTENT ,R.WRITE_TIME ,R.DELETE_YN ,R.MODIFY_DATE ,R.HANDLE_REPORT_YN,R.REPORT_COMMENT,U.NICK AS WRITER FROM REPORT R JOIN \"USER\" U ON R.WRITER = U.USER_NO WHERE R.POST_NO = ?";
    ...
    public List<ReportVo> selectReportList(Connection conn, String writer) {
        ...
        String sql = "SELECT R.POST_NO ,U.USER_NO ,SERVICE_NO ,R.TITLE , R.CONTENT ,R.WRITE_TIME ,R.DELETE_YN, R.MODIFY_DATE ,R.HANDLE_REPORT_YN ,R.REPORT_COMMENT ,U.NICK AS WRITER FROM REPORT R JOIN \"USER\" U ON R.WRITER = U.USER_NO WHERE R.DELETE_YN = 'N'AND U.NICK=? ORDER BY R.POST_NO DESC";
