...
@WebServlet(urlPatterns = "/member/mypost")
@MultipartConfig(
...
public class MemberMypageController4 extends HttpServlet{
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      //화면
        ...
        if(loginMember != null) {
            req.getRequestDispatcher("/WEB-INF/views/member/mypage07.jsp").forward(req, resp);
        }else {
