...
public class ServiceVo {
    ...
    public ServiceVo(int serviceNo, int typeNo, int helperNo, String profileImg, int charge, String chargeUnit,
            int helperExp, Timestamp openTime, Timestamp closeTime, String serviceDetail, String paymentDetail,
            String servicePic_1, String servicePic_2, String servicePic_3, String servicePic_4, int pTypeNo_1,
            int pTypeNo_2, int pTypeNo_3, int areaNo_1, int areaNo_2, int areaNo_3, int areaNo_4, int areaNo_5) {
        super();
    ...
    public String toString() {
        return "ServiceVo [serviceNo=" + serviceNo + ", typeNo=" + typeNo + ", helperNo=" + helperNo + ", profileImg="
                + profileImg + ", charge=" + charge + ", chargeUnit=" + chargeUnit + ", helperExp=" + helperExp
                + ", openTime=" + openTime + ", closeTime=" + closeTime + ", serviceDetail=" + serviceDetail
